...
class TopicTracker:
    ...
    def __init__(self, topic_keywords: Dict[str, List[str]] = None):
        self.topic_keywords = topic_keywords or self._default_executive_keywords()
        self.discussed_topics: List[str] = []

    def _default_executive_keywords(self) -> Dict[str, List[str]]:
        """Default executive topic keywords."""
        return {
...
def create_topic_tracker() -> TopicTracker:
    """Create topic tracker with executive-specific keywords."""
    return TopicTracker()
